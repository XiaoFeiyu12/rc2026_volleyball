...
这套算法最早其实还包括机械臂的解算规划和仿真，不过后面发现接球时deta机械臂只需直上直下操作即可，并不像串联机械臂那般复杂。由于机械进度，这个孩子实际测试只有短短不到两周，迫在眉睫的我们不得不被迫舍弃他停止测试，转而寻求一种能够直接执行的低复杂的方案，也就是后面的`ibvs`视觉伺服控制方案。短短三天内从在这套方案，历经纯图像PID方案，再到IBVS的快速迭代断舍离。。。   
不过赛场上见到了从去年就一直观摹、学习的东大全自动展现，还是挺满足的。今年由于对抗赛的规则，自动接球是一件更难的事了，除了东大几乎所有学校都是手动——视觉算法被抛弃了。   
如果说今年用两个字形容我的代码，那无疑是遗憾了。我们队本身是打RM，今年打不上超抗剩余人员被迫转向RC。而明年之后战队重新奔赴超抗，这份代码这份算法也没有传承价值了，索性开源吧。如果你们在2027年的RC上有看到福州大学，请记住那不是我们。  
再见，这份承载了我一年学习、知识、夜晚和遗憾的代码。
