 ...
 ****************************************************************/
inline ProcessModel make_ballist_3d(double q_sxy_min, double q_sxy_max, double q_sz_min, double q_sz_max, double g = 9.8)
{
 ...
 * @brief 三维线性空气阻力模型
 ****************************************************************/
inline ProcessModel make_linear_drag_3d(double q_sxy_min, double q_sxy_max, double q_sz_min, double q_sz_max, double k,
