...
PlannerNode::PlannerNode() : Node("planner_node")
{
    ...
    striking_point_bias_ << armjoint_to_strikingpoint * sin(delta_arm_angle /180.0 * 3.1415926),
                            0,
    ...
    ball_trajectory_sub_ = this->create_subscription<BallTrajectory>("/predictor/ball_trajectory", rclcpp::SensorDataQoS(), 
        std::bind(&PlannerNode::BallTrajectoryCallback, this, std::placeholders::_1));
...
void PlannerNode::BallTrajectoryCallback(const BallTrajectory::SharedPtr msg)
{
